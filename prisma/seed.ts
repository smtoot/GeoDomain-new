...
async function main() {
  ...
  // Create comprehensive test domains with new geographic scope and category fields
  const testDomains = [
    {
      ...
      metaTitle: 'TechStartup.com - Premium Technology Startup Domain',
      metaDescription: 'Premium domain for technology startups. Perfect for innovative tech companies in San Francisco and beyond.',
    },
    {
      ...
      metaTitle: 'RealEstatePro.com - Professional Real Estate Domain',
      metaDescription: 'Professional real estate domain for agents and brokers in New York. Established brand potential.',
    },
    {
      ...
      metaTitle: 'HealthcarePlus.com - Premium Healthcare Domain',
      metaDescription: 'Premium healthcare domain for medical services in Houston, Texas. Trustworthy and professional.',
    },
    {
      name: 'financehub.com',
      price: 25000,
      ...
      metaTitle: 'FinanceHub.com - High-Value Financial Services Domain',
      metaDescription: 'High-value finance domain for financial services in Los Angeles. Premium financial brand.',
    },
    {
      ...
      metaTitle: 'TechSolutions.com - Technology Solutions Domain',
      metaDescription: 'Technology solutions domain for IT companies in Seattle. Professional tech services.',
    },
    {
      name: 'restaurantguide.com',
      price: 5500,
      priceType: 'NEGOTIABLE' as const,
      description: 'Restaurant guide directory domain for food and dining. Perfect for food industry.',
      geographicScope: 'CITY' as const,
      state: 'Illinois',
      city: 'Chicago',
    ...
    },
    {
      ...
      metaTitle: 'CryptoTrader.com - Premium Cryptocurrency Trading Domain',
      metaDescription: 'Premium cryptocurrency trading domain. High-value crypto brand for national trading platforms.',
    },
    {
      name: 'fitnesspro.com',
      price: 6500,
    ...
    // Add more domains with different geographic scopes
    {
      name: 'usahotels.com',
      price: 45000,
      priceType: 'MAKE_OFFER' as const,
    ...
    },
    {
      ...
      price: 32000,
      priceType: 'FIXED' as const,
      description: 'State-wide restaurant directory for California dining.',
      geographicScope: 'STATE' as const,
      state: 'California',
      city: null,
      category: 'Restaurants & Food',
