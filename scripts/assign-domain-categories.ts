...
async function assignDomainCategories() {
  try {
    console.log('🔧 Starting domain category assignment...');
    ...
    console.log('🎉 Domain category assignment completed!');
    ...
    console.error('❌ Error assigning domain categories:', error);
  } finally {
    await prisma.$disconnect();
  }
}

assignDomainCategories();
