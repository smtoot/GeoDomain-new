...
interface DomainModerationProps {
  domains: Domain[];
  onModerateDomain: (domainId: string, action: string, notes?: string, rejectionReason?: string, requestedChanges?: string[]) => Promise<void>;
  isLoading?: boolean;
}
    ...
    try {
      ...
      switch (moderationAction) {
        ...
        case 'request-changes':
          ...
          requestedChangesValue = requestedChangesValue;
          break;
        default:
          action = 'APPROVE';
      }

      await onModerateDomain(
        selectedDomain.id,
        action,
        notes,
        rejectionReasonValue,
        requestedChangesValue
      );
