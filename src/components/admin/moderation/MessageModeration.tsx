...
import { Eye, Check, X, Edit, User, Globe } from 'lucide-react';
...
interface MessageModerationProps {
  ...
  onModerate: (messageId: string, action: 'APPROVE' | 'REJECT' | 'EDIT', data: any) => Promise<void>;
}

export function MessageModeration({ message, onModerate }: MessageModerationProps) {
  ...
  const handleModeration = async () => {
    ...
    try {
      await onModerate(message.id, action, {
        adminNotes: notes,
